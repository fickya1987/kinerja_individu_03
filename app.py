...
if uploaded_file:
    ...
    if openai.api_key:
        with st.expander("🧠 Narasi Analisis dari Pelindo AI"):
            ...
            5. Analisa juga jumlah sebaran distribusi pekerja sesuai hasil distribusi normal, seperti berikan jumlah pekerja yang di kategori sebaran kiri, tengah, atau kanan.
            """
